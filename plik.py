...
# latitude = input("Podaj szerokość geograficzna: ")
# longitude = input("Podaj długość geograficzną: ")
searched_data = input("Podaj date: ")

data_in_memory = file_hanlder.get_data_from_file(searched_data)
if data_in_memory:
    ...
    czy_bedzie_padac = retrive_data_from_api(searched_data)
    file_hanlder.add_new_date_to_data(searched_data, czy_bedzie_padac)
